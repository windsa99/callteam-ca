...
assert(scripts.length === 50, `Expected 50 scripts, found ${scripts.length}.`);
...
for (const script of scripts) {
  ...
  if (newResourceIds.has(script.id) || waveFourIds.has(script.id) || waveFiveIds.has(script.id) || waveSixIds.has(script.id) || waveSevenIds.has(script.id) || waveEightIds.has(script.id) || waveNineIds.has(script.id)) {
    const expectedDate = waveSixIds.has(script.id) || waveSevenIds.has(script.id) || waveEightIds.has(script.id) || waveNineIds.has(script.id) ? "2026-08-23" : waveFiveIds.has(script.id) || waveFourIds.has(script.id) ? "2026-08-17" : "2026-08-16";
  ...
  if (waveFourIds.has(script.id) || waveFiveIds.has(script.id) || waveSixIds.has(script.id) || waveSevenIds.has(script.id) || waveEightIds.has(script.id) || waveNineIds.has(script.id)) {
