...
for (const script of scripts) {
  ...
  if (waveSixIds.has(script.id) || waveSevenIds.has(script.id) || waveEightIds.has(script.id) || waveNineIds.has(script.id) || waveTenIds.has(script.id) || waveElevenIds.has(script.id) || waveTwelveIds.has(script.id)) {
  ...
  if (waveTenIds.has(script.id) || waveElevenIds.has(script.id) || waveTwelveIds.has(script.id)) {
