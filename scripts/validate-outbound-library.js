...
if (articleFiles.length !== 109) fail(`Expected 109 article files, found ${articleFiles.length}.`);
...
if (callScripts.length !== 60) fail(`Expected 60 cold-call scripts, found ${callScripts.length}.`);
