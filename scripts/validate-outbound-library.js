...
if (articleFiles.length !== 114) fail(`Expected 114 article files, found ${articleFiles.length}.`);
...
if (callScripts.length !== 70) fail(`Expected 70 cold-call scripts, found ${callScripts.length}.`);
