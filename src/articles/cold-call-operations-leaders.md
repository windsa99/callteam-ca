...
cards:
  - title: "One workflow"
    text: "Name the inspection, escalation, scheduling, reporting, fulfillment, service, or frontline process the offer affects."
  - title: "One operating measure"
    text: "Connect the workflow to throughput, delay, rework, service level, quality, safety, utilization, capacity, or control."
  - title: "One pressure condition"
    text: "Ask what happens during growth, peak volume, staff absence, a site change, an exception, or a compliance event."
  - title: "One next decision"
    text: "Use the meeting to validate the process, compare an option, scope a pilot, or involve the correct operating owner."
relatedService:
  title: "Outsourced SDR Services"
  url: "/services/outsourced-sdr/"
  text: "Run industry-specific Operations outreach with researched accounts, human calls, workflow-aware qualification, follow-up, and usable sales context."
relatedCaseStudy:
  ...
  text: "See how focused messaging and specialized qualification helped create conversations in a demanding operating market."
relatedResourcesLabel: "Operations call scripts"
relatedResourcesHeading: "Move from general guidance to a real operating workflow."
relatedResources:
  - title: "Frontline Workforce Software Cold Call Script"
    url: "/resources/cold-call-scripts/frontline-workforce-software-cold-call-script/"
    text: "Discuss how critical work reaches deskless teams across shifts, sites, supervisors, and exception paths."
    label: "Frontline operations"
    linkText: "Open the frontline workforce script"
  - title: "Industrial Alarm Notification Cold Call Script"
    url: "/resources/cold-call-scripts/industrial-alarm-notification-cold-call-script/"
    text: "Explore alarm escalation, notification, response ownership, auditability, and failure handling in industrial settings."
    label: "Industrial operations"
    linkText: "Open the alarm notification script"
  - title: "Field Inspection Software Cold Call Script"
    ...
    text: "Qualify paper, spreadsheet, PDF, email, and legacy inspection workflows across field teams and reviewers."
    label: "Field operations"
    linkText: "Open the field inspection script"
  - title: "How to Sell Automation When the Manual Process Still Works"
    url: "/articles/sell-automation-manual-process-still-works/"
    text: "Find the operating threshold where a familiar process becomes difficult to scale, control, or audit."
...
faqs:
  ...
  - question: "What is wrong with an efficiency pitch?"
    answer: "Efficiency has no commercial meaning until the seller identifies the work, baseline, constraint, measure, and tradeoff involved. A generic claim also ignores whether the current process is already adequate for the buyer."
...
sources:
  ...
  - name: "IBM Institute for Business Value: AI and automation opportunity"
    url: "https://www.ibm.com/thought-leadership/institute-business-value/en-us/report/ai-and-automation"
  - name: "Gong: A data-backed guide to discovery calls"
    url: "https://www.gong.io/blog/discovery-call/"
readNext:
  - title: "How to Sell Automation When the Manual Process Still Works"
    url: "/articles/sell-automation-manual-process-still-works/"
...
aboutLinks:
  ...
  - title: "Browse industry call scripts"
    url: "/resources/cold-call-scripts/"
  - title: "Learn about CallTeam"
    url: "/about/"
ctaHeading: "Want CallTeam to run the campaign?"
ctaText: "Book a free B2B strategy call to define the Operations audience, workflow premise, call path, qualification, follow-up, and handoff."
